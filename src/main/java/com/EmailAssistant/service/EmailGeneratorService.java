...
public class EmailGeneratorService {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional email reply for the following email content. Please don't generate the subject line. And No need to write Okay here is email and all, start from dear/respected/Hi /Hello etc. ");
